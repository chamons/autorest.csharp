...
namespace CognitiveServices.TextAnalytics
{
    ...
    {
        private const ServiceVersion LatestVersion = ServiceVersion.Vv3_1_preview_1;

        /// <summary> The version of the service to use. </summary>
        public enum ServiceVersion
        {
            /// <summary> Service version "v3.1-preview.1". </summary>
            Vv3_1_preview_1 = 1,
        }
        ...
        public CognitiveServicesTextAnalyticsClientOptions(ServiceVersion version = LatestVersion)
        {
            ...
            {
                ServiceVersion.Vv3_1_preview_1 => "v3.1-preview.1",
