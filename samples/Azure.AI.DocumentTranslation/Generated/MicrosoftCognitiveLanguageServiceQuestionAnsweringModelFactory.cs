...
namespace Azure.AI.DocumentTranslation
{
    ...
    public static partial class MicrosoftCognitiveLanguageServiceQuestionAnsweringModelFactory
    {
        ...
        public static KnowledgebaseAnswers KnowledgebaseAnswers(IReadOnlyList<KnowledgebaseAnswer> answers = default)
        {
            answers ??= new List<KnowledgebaseAnswer>();
            return new KnowledgebaseAnswers(answers);
        }

        /// <summary> Initializes new instance of KnowledgebaseAnswer class. </summary>
        ...
        public static KnowledgebaseAnswer KnowledgebaseAnswer(IReadOnlyList<string> questions = default, string answer = default, double? confidenceScore = default, int? id = default, string source = default, IReadOnlyDictionary<string, string> metadata = default, KnowledgebaseAnswerDialog dialog = default, AnswerSpan answerSpan = default)
        {
            questions ??= new List<string>();
            metadata ??= new Dictionary<string, string>();
            return new KnowledgebaseAnswer(questions, answer, confidenceScore, id, source, metadata, dialog, answerSpan);
        }

        /// <summary> Initializes new instance of KnowledgebaseAnswerDialog class. </summary>
        ...
        public static KnowledgebaseAnswerDialog KnowledgebaseAnswerDialog(bool? isContextOnly = default, IReadOnlyList<KnowledgebaseAnswerPrompt> prompts = default)
        {
            prompts ??= new List<KnowledgebaseAnswerPrompt>();
            return new KnowledgebaseAnswerDialog(isContextOnly, prompts);
        }

        /// <summary> Initializes new instance of KnowledgebaseAnswerPrompt class. </summary>
        ...
        /// <summary> Initializes new instance of AnswerSpan class. </summary>
        ...
        /// <summary> Initializes new instance of TextAnswers class. </summary>
        ...
        public static TextAnswers TextAnswers(IReadOnlyList<TextAnswer> answers = default)
        {
            answers ??= new List<TextAnswer>();
            return new TextAnswers(answers);
        }

        /// <summary> Initializes new instance of TextAnswer class. </summary>
        ...
        public static TextAnswer TextAnswer(string answer = default, double? confidenceScore = default, string id = default, AnswerSpan answerSpan = default, int? offset = default, int? length = default)
        {
