...
{
    internal class RestStatusCodeHelper
    {
        internal const string ClientDiagnosticsVariable = "clientDiagnostics";
        internal const string ClientDiagnosticsField = "_" + ClientDiagnosticsVariable;

        //TODO: Do multiple status codes
        internal static void WriteStatusCodeSwitch(CodeWriter writer, CodeWriterDeclaration message, RestClientMethod operation, bool async)
        {
