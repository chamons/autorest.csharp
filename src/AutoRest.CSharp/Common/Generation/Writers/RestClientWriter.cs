...
namespace AutoRest.CSharp.Generation.Writers
{
    internal class RestClientWriter
    {
        ...
        private void WriteClientFields(CodeWriter writer, RestClient restClient)
        {
            ...
            writer.Line($"private {typeof(ClientDiagnostics)} {RestStatusCodeHelper.ClientDiagnosticsField};");
        ...
        private void WriteClientCtor(CodeWriter writer, RestClient restClient, CSharpType cs)
        {
            ...
            writer.WriteXmlDocumentationParameter(RestStatusCodeHelper.ClientDiagnosticsVariable, "The handler for diagnostic messaging in the client.");
            ...
            writer.Append($"public {cs.Name:D}({typeof(ClientDiagnostics)} {RestStatusCodeHelper.ClientDiagnosticsVariable}, {typeof(HttpPipeline)} {PipelineVariable},");
            foreach (Parameter clientParameter in restClient.Parameters)
            {
            ...
            using (writer.Scope())
            {
                ...
                writer.Line($"{RestStatusCodeHelper.ClientDiagnosticsField} = {RestStatusCodeHelper.ClientDiagnosticsVariable};");
        ...
        private void WriteOperation(CodeWriter writer, RestClientMethod operation, bool async)
        {
            ...
            using (writer.Scope())
            {
                ...
                RestStatusCodeHelper.WriteStatusCodeSwitch(writer, messageVariable, operation, async);
            }
            writer.Line();
        }
    }
